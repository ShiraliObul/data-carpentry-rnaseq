...
[Link to exercise](00_exercises.html#41_ma_plot)

----

From the coloured clouds of points, we can see that more genes seem to 
...
In the [clustering lesson](05_rnaseq_clustering.html) we will see how we can partition 
