...
(revisit the [Data Carpentry lesson](http://www.datacarpentry.org/R-ecology-lesson/03-dplyr.html#reshaping_with_gather_and_spread)
...
> Convert the `raw_cts` created above to a "long" format using the `gather()` function

[Link to full exercise](00_exercises.html#21_gather_table)
