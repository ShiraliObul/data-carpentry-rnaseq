...
3. Look at the `prcomp()` help page to identify which parts of the object contain the _PC scores_, _eigenvalues_ and _variable loadings_? 
...
4. Extract these three elements from the object? (hint: use `$`)
